...
Functional CSS for spacing

## Filesize

| File | Size |
|------|------|
| `dist/spacing.css` | 19904 bytes |
| `dist/spacing.min.css` | 13185 bytes (1975 Gzipped) |
...
```html
<link rel="stylesheet" href="https://unpkg.com/css-spacing/dist/spacing.min.css">
```

### Direct

```html
<link rel="stylesheet" href="path/to/css-spacing/dist/spacing.min.css">
```
...
| `.pan-s` | `padding: 0;` |
| `.paxs-s` | `padding: .25rem;` |
| `.pas-s` | `padding: .5rem;` |
| `.pam-s` | `padding: 1rem;` |
| `.pal-s` | `padding: 2rem;` |
| `.pax-s` | `padding: 4rem;` |
| `.paxl-s` | `padding: 8rem;` |
| `.paxxl-s` | `padding: 16rem;` |
| `.pln-s` | `padding-left: 0;` |
| `.plxs-s` | `padding-left: .25rem;` |
| `.pls-s` | `padding-left: .5rem;` |
| `.plm-s` | `padding-left: 1rem;` |
| `.pll-s` | `padding-left: 2rem;` |
| `.plx-s` | `padding-left: 4rem;` |
| `.plxl-s` | `padding-left: 8rem;` |
| `.plxxl-s` | `padding-left: 16rem;` |
| `.prn-s` | `padding-right: 0;` |
| `.prxs-s` | `padding-right: .25rem;` |
| `.prs-s` | `padding-right: .5rem;` |
| `.prm-s` | `padding-right: 1rem;` |
| `.prl-s` | `padding-right: 2rem;` |
| `.prx-s` | `padding-right: 4rem;` |
| `.prxl-s` | `padding-right: 8rem;` |
| `.prxxl-s` | `padding-right: 16rem;` |
| `.pbn-s` | `padding-bottom: 0;` |
| `.pbxs-s` | `padding-bottom: .25rem;` |
| `.pbs-s` | `padding-bottom: .5rem;` |
| `.pbm-s` | `padding-bottom: 1rem;` |
| `.pbl-s` | `padding-bottom: 2rem;` |
| `.pbx-s` | `padding-bottom: 4rem;` |
| `.pbxl-s` | `padding-bottom: 8rem;` |
| `.pbxxl-s` | `padding-bottom: 16rem;` |
| `.ptn-s` | `padding-top: 0;` |
| `.ptxs-s` | `padding-top: .25rem;` |
| `.pts-s` | `padding-top: .5rem;` |
| `.ptm-s` | `padding-top: 1rem;` |
| `.ptl-s` | `padding-top: 2rem;` |
| `.ptx-s` | `padding-top: 4rem;` |
| `.ptxl-s` | `padding-top: 8rem;` |
| `.ptxxl-s` | `padding-top: 16rem;` |
| `.pvn-s` | `padding-top: 0;     padding-bottom: 0;` |
| `.pvxs-s` | `padding-top: .25rem;     padding-bottom: .25rem;` |
| `.pvs-s` | `padding-top: .5rem;     padding-bottom: .5rem;` |
| `.pvm-s` | `padding-top: 1rem;     padding-bottom: 1rem;` |
| `.pvl-s` | `padding-top: 2rem;     padding-bottom: 2rem;` |
| `.pvx-s` | `padding-top: 4rem;     padding-bottom: 4rem;` |
| `.pvxl-s` | `padding-top: 8rem;     padding-bottom: 8rem;` |
| `.pvxxl-s` | `padding-top: 16rem;     padding-bottom: 16rem;` |
| `.phn-s` | `padding-left: 0;     padding-right: 0;` |
| `.pvxs-s` | `padding-left: .25rem;     padding-right: .25rem;` |
| `.phs-s` | `padding-left: .5rem;     padding-right: .5rem;` |
| `.phm-s` | `padding-left: 1rem;     padding-right: 1rem;` |
| `.phl-s` | `padding-left: 2rem;     padding-right: 2rem;` |
| `.phx-s` | `padding-left: 4rem;     padding-right: 4rem;` |
| `.phxl-s` | `padding-left: 8rem;     padding-right: 8rem;` |
| `.phxxl-s` | `padding-left: 16rem;     padding-right: 16rem;` |
| `.man-s` | `margin: 0;` |
| `.maxs-s` | `margin: .25rem;` |
| `.mas-s` | `margin: .5rem;` |
| `.mam-s` | `margin: 1rem;` |
...
| `.max-s` | `margin: 4rem;` |
| `.maxl-s` | `margin: 8rem;` |
| `.maxxl-s` | `margin: 16rem;` |
| `.mln-s` | `margin-left: 0;` |
| `.mlxs-s` | `margin-left: .25rem;` |
| `.mls-s` | `margin-left: .5rem;` |
| `.mlm-s` | `margin-left: 1rem;` |
| `.mll-s` | `margin-left: 2rem;` |
| `.mlx-s` | `margin-left: 4rem;` |
| `.mlxl-s` | `margin-left: 8rem;` |
| `.mlxxl-s` | `margin-left: 16rem;` |
| `.mrn-s` | `margin-right: 0;` |
| `.mrxs-s` | `margin-right: .25rem;` |
| `.mrs-s` | `margin-right: .5rem;` |
| `.mrm-s` | `margin-right: 1rem;` |
| `.mrl-s` | `margin-right: 2rem;` |
| `.mrx-s` | `margin-right: 4rem;` |
| `.mrxl-s` | `margin-right: 8rem;` |
| `.mrxxl-s` | `margin-right: 16rem;` |
| `.mbn-s` | `margin-bottom: 0;` |
| `.mbxs-s` | `margin-bottom: .25rem;` |
| `.mbs-s` | `margin-bottom: .5rem;` |
| `.mbm-s` | `margin-bottom: 1rem;` |
| `.mbl-s` | `margin-bottom: 2rem;` |
| `.mbx-s` | `margin-bottom: 4rem;` |
| `.mbxl-s` | `margin-bottom: 8rem;` |
| `.mbxxl-s` | `margin-bottom: 16rem;` |
| `.mtn-s` | `margin-top: 0;` |
| `.mtxs-s` | `margin-top: .25rem;` |
| `.mts-s` | `margin-top: .5rem;` |
| `.mtm-s` | `margin-top: 1rem;` |
| `.mtl-s` | `margin-top: 2rem;` |
| `.mtx-s` | `margin-top: 4rem;` |
| `.mtxl-s` | `margin-top: 8rem;` |
| `.mtxxl-s` | `margin-top: 16rem;` |
| `.mvn-s` | `margin-top: 0;     margin-bottom: 0;` |
| `.mvxs-s` | `margin-top: .25rem;     margin-bottom: .25rem;` |
| `.mvs-s` | `margin-top: .5rem;     margin-bottom: .5rem;` |
| `.mvm-s` | `margin-top: 1rem;     margin-bottom: 1rem;` |
| `.mvl-s` | `margin-top: 2rem;     margin-bottom: 2rem;` |
| `.mvx-s` | `margin-top: 4rem;     margin-bottom: 4rem;` |
| `.mvxl-s` | `margin-top: 8rem;     margin-bottom: 8rem;` |
| `.mvxxl-s` | `margin-top: 16rem;     margin-bottom: 16rem;` |
| `.mhn-s` | `margin-left: 0;     margin-right: 0;` |
| `.mhs-s` | `margin-left: .5rem;     margin-right: .5rem;` |
| `.mhm-s` | `margin-left: 1rem;     margin-right: 1rem;` |
| `.mhl-s` | `margin-left: 2rem;     margin-right: 2rem;` |
| `.mhx-s` | `margin-left: 4rem;     margin-right: 4rem;` |
| `.mhxl-s` | `margin-left: 8rem;     margin-right: 8rem;` |
| `.mhxxl-s` | `margin-left: 16rem;     margin-right: 16rem;` |
| `.pan-m` | `padding: 0;` |
...
| `.mvn-m` | `margin-top: 0;     margin-bottom: 0;` |
...
| `.mvn-l` | `margin-top: 0;     margin-bottom: 0;` |
...
Example: `.pan-m` applies the property at the medium breakpoint and above.
...
Processes `src/spacing.css` with [Lightning CSS](https://lightningcss.dev) and outputs to `dist/`.

- `dist/spacing.css` — formatted
- `dist/spacing.min.css` — minified
